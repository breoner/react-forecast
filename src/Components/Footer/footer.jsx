...
function Footer({ isDark }) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1160px] flex-col gap-[30px] px-[10px] md:flex-row md:items-start md:justify-between">
        <div>
          <img
            src={logo}
            alt="Logo"
      ...
      <div
        className={`mx-auto mt-[35px] w-full max-w-[1160px] border-t px-[10px] pt-[20px] transition-colors duration-300 ${
